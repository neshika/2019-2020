...
<table><tr><td>
       <table class="table1" cellpadding="2">2
        ...
        <tr><td>ГК: <?php echo do_gencode($array2['a'][0],$array2['b'][0],$array2['c'][0],$array2['d'][0],$array2['p'][0],$array2['m'][0]);?>
      ...
      <table class="table1" cellpadding="2">1 
        ...
        </td><td valign="top" rowspan="2">данные собаки правый столбец<br><br>
      ...
      <tr><td>ГК: <?php echo do_gencode($array['a'][0],$array['b'][0],$array['c'][0],$array['d'][0],$array['p'][0],$array['m'][0]);?>
